...
def add_widgets():
    ...
    standardDeduction_label.grid(row=0, column=0, padx=10, pady=10, sticky = "n")
    ...
    totalIncome_label.grid(row=2, column=0, padx=10, pady=10, sticky = "w")
    ...
    hra_label.grid(row=3, column=0, padx=10, pady=10, sticky = "w")
    ...
    coOperation_label.grid(row=4, column=0, padx=10, pady=10, sticky = "w")
    ...
    gpf_label.grid(row=5, column=0, padx=10, pady=10, sticky = "w")
    ...
    childTution_label.grid(row=6, column=0, padx=10, pady=10, sticky = "w")
    ...
    lic_label.grid(row=7, column=0, padx=10, pady=10, sticky = "w")
    ...
    hlp_label.grid(row=8, column=0, padx=10, pady=10, sticky = "w")
    ...
    section80CCC_label.grid(row=9, column=0, padx=10, pady=10, sticky = "w")
    ...
    section80CCD_label.grid(row=10, column=0, padx=10, pady=10, sticky = "w")
    ...
    pmRelief_label.grid(row=11, column=0, padx=10, pady=10, sticky = "w")
    ...
    cmRelief_label.grid(row=12, column=0, padx=10, pady=10, sticky = "w")
    ...
    hli_label.grid(row=13, column=0, padx=10, pady=10, sticky = "w")
    ...
    mediClaim_label.grid(row=14, column=0, padx=10, pady=10, sticky = "w")
    ...
    childException_label.grid(row=15, column=0, padx=10, pady=10, sticky = "w")
    ...
    advanceTax_label.grid(row=16, column=0, padx=10, pady=10, sticky = "w")
